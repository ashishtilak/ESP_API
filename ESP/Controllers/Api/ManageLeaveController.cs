    ...
    public class ManageLeaveController : ApiController
    {
        ...
        public IHttpActionResult ManageLeave([FromBody] object requestData, string empUnqId)
        {
            ...
            List<DateTime> holidays =
                CustomHelper.GetHolidays(changedLeave.FromDt, changedLeave.ToDt, lDto.CompCode, lDto.WrkGrp,
                    emp.Location);
            ...
            List<DateTime> weekOffs =
                CustomHelper.GetWeeklyOff(changedLeave.FromDt, changedLeave.ToDt, empUnqId);
